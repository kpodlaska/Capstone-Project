...
def init_arg_parser():
    ...
    parser.add_argument('--path_to_save_files',
                        help="Define a path to output file. For current path use '.', As deflaut is ./Users/kpodlaska/PycharmProjects/pythonProject/Capstone",
                        type=str,
...
def main():
    ...
    if parsed_args.clear_files_in_path():
